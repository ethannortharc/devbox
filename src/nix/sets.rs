...
pub static NIX_SETS: &[NixSet] = &[
    ...
    NixSet {
        name: "container",
        packages: &[
            "docker", "docker-compose", "lazydocker", "dive", "buildkit", "skopeo",
        ],
    },
    NixSet {
        name: "network",
    ...
    NixSet {
        name: "lang-python",
        packages: &[
            "python312", "uv", "ruff", "pyright", "python312Packages.ipython",
            "python312Packages.pytest",
        ],
    },
    NixSet {
        name: "lang-node",
        packages: &["nodejs_22", "bun", "pnpm", "typescript", "nodePackages.typescript-language-server", "biome"],
    },
    NixSet {
        name: "lang-java",
